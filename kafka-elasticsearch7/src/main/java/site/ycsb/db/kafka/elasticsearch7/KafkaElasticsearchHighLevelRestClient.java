...
package site.ycsb.db.kafka.elasticsearch7;
...
import static site.ycsb.db.kafka.elasticsearch7.Elasticsearch7.KEY;
import static site.ycsb.db.kafka.elasticsearch7.Elasticsearch7.parseIntegerProperty;
import static site.ycsb.db.kafka.elasticsearch7.Elasticsearch7.parseStringProperty;
...
public class KafkaElasticsearchHighLevelRestClient extends DB {

  private RestHighLevelClient client;
  private static KafkaElasticsearchHighLevelRestClient instance;
  ...
  public static KafkaElasticsearchHighLevelRestClient getInstance() {
    if (instance == null) {
      instance = new KafkaElasticsearchHighLevelRestClient();
    }
    return instance;
  }
